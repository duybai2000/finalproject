  ...
  return (
    <div className="min-h-screen flex items-center justify-center pt-20 px-4 relative z-10 w-full">
      ...
      >
        ...
        <p className="text-gray-400 text-center mb-8">Welcome back to Ride &amp; Rent</p>
        ...
        <p className="text-center text-gray-400 mt-6">
          No account yet? <Link href="/register" className="text-blue-400 hover:underline">Sign up here</Link>
        </p>
      </motion.div>
    </div>
  );
